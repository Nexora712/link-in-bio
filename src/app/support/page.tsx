              ...
              <div key={category} className="mb-8">
                ...
                <div className="space-y-4">
                  {questions.map((faq, index) => (
                    <div key={index} className="bg-white p-6 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl">
                      ...
                      <div className="accordion-content hidden p-6 border-t border-gray-200">
